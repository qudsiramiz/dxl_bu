...
#    plot_duration=1
    ...
    for (swp_fl, mag_fl) in zip(swepam_files_list, mag_files_list):
        ...
        mag_df_list[count] = pd.read_csv(mag_fl, sep=r'\s{1,}', skiprows=20, names=ace_key_list_mag,
                                 engine='python', dtype={"month":"string", "date":"string",
                                                         "utctime":"string"})
        swp_df_list[count] = pd.read_csv(swp_fl, sep=r'\s{1,}', skiprows=18, names=ace_key_list_swp,
                                 engine='python', dtype={"month":"string", "date":"string",
                                                         "utctime":"string"})
        count += 1
