...
#for xxx in range(1):
    ...
    df_ace_mag = pd.read_csv(ace_url_mag, sep=r'\s{1,}', skiprows=20, names=ace_key_list_mag,
                             engine='python', dtype={"month":"string", "date":"string",
                                                     "utctime":"string"})
    df_ace_swp = pd.read_csv(ace_url_swp, sep=r'\s{1,}', skiprows=18, names=ace_key_list_swp,
                             engine='python', dtype={"month":"string", "date":"string",
                                                     "utctime":"string"})
