...
def line_trace():
    ...
    try:
        ...
        fig_name_hist = f"/mnt/cephadrius/bu_research/dxl/figures/historical/line_trace/Earthsmagnetic_field_{t}.png"
        ...
        print(
            f"Code execution finished at (UTC):"
            + f"{datetime.datetime.utcfromtimestamp(time.time()).strftime('%Y-%m-%d %H:%M:%S')}\n"
        )
