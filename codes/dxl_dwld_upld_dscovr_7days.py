...
# for foo in range(1):
    ...
    # start = time.time()
    print(f"Code execution for DSCOVR 7 days data started at at (UTC):" +
    ...
    axs5.set_xlabel(f'Date and time starting on {df_dsco.index.date[0]} (UTC) [DD, HH:MM]', fontsize=xlabelsize)
    ...
    fig_name_hist = f"/media/cephadrius/endless/bu_research/dxl/figures/historical/dscovr/7days/sw_dsco_parameters_7days_{t}.png"
