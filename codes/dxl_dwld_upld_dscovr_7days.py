...
def plot_figures_dsco_7days():
    ...
    # start = time.time()
    print(
        f"Code execution for DSCOVR 7 days data started at at (UTC):"
    ...
    df_dsco["bm"] = np.sqrt(
        df_dsco.bx_gsm**2 + df_dsco.by_gsm**2 + df_dsco.bz_gsm**2
    )
    ...
    axs5.set_xlabel(
        f"Date and time starting on {df_dsco.index.date[0]} (UTC) [DD, HH:MM]",
        fontsize=xlabelsize,
    )
    ...
    fig_name_gdr = f"/home/cephadrius/google-drive/Studies/Research/bu_research/dxl/figures/sw_dsco_parameters_7days.png"
    plt.savefig(
    ...
    fig_name_hist = f"/mnt/cephadrius/bu_research/dxl/figures/historical/dscovr/7days/sw_dsco_parameters_7days_{t}.png"
